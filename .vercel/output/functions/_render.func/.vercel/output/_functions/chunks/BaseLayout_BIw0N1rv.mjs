import { b as createAstro, c as createComponent, m as maybeRenderHead, d as addAttribute, e as renderSlot, a as renderTemplate, s as spreadAttributes, u as unescapeHTML, r as renderComponent, i as renderScript, j as renderHead } from './astro/server_Dr6oDi21.mjs';
import 'clsx';
/* empty css                         */
/* empty css                         */

const $$Astro$4 = createAstro("https://tuanng.dev");
...
}, "F:/tuanngo/Dijnie/src/components/Hero.astro", void 0);

var __freeze = Object.freeze;
var __defProp = Object.defineProperty;
var __template = (cooked, raw) => __freeze(__defProp(cooked, "raw", { value: __freeze(cooked.slice()) }));
var _a;
const $$Astro$3 = createAstro("https://tuanng.dev");
const $$MainHead = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$3, $$props, $$slots);
  Astro2.self = $$MainHead;
  const {
    title = "Tuan Ngo: Personal Site",
    description = "The personal site of Tuan Ngo"
  } = Astro2.props;
...
}, "F:/tuanngo/Dijnie/src/components/MainHead.astro", void 0);
...
const $$Astro$2 = createAstro("https://tuanng.dev");
...
const $$Nav = createComponent(($$result, $$props, $$slots) => {
  ...
  const iconLinks = [
    {
      label: "Twitter",
      href: "https://x.com/vtuann_13205",
      icon: "twitter-logo"
    },
    // { label: 'Twitch', href: 'https://twitch.tv/me', icon: 'twitch-logo' },
    { label: "GitHub", href: "https://github.com/vantuann205", icon: "github-logo" }
  ...
  return renderTemplate`${maybeRenderHead()}<nav data-astro-cid-dmqpwcec> <div class="menu-header" data-astro-cid-dmqpwcec> <a href="/" class="site-title" data-astro-cid-dmqpwcec> ${renderComponent($$result, "Icon", $$Icon, { "icon": "sun", "color": "var(--accent-regular)", "size": "1.6em", "gradient": true, "data-astro-cid-dmqpwcec": true })}
Tuan Ngo
